"""
Django settings for retailx7 project.
...
SECRET_KEY = 'django-insecure-$rt00p%-4yo0-04#z=7!yat2h!^jt#2@&^ns1mk&)dohz5=2!o'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["devops.tlapp.net", "51.178.36.169"]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'Home.context_processors.user_images',
                'Home.context_processors.chatbot_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'retailx7.wsgi.application'
